...
namespace _1wireXamarinForms.DalSemi.OneWire.Container
{
    ...
    public class OneWireContainer
    {
		...
		/// <see cref="_1wireXamarinForms.DalSemi.OneWire.Utils.Address"/>
		...
		{
			get { return _1wireXamarinForms.DalSemi.OneWire.Utils.Address.ToString(address); }
		}
		...
		{
			return _1wireXamarinForms.DalSemi.OneWire.Utils.Address.ToString(this.address) + " " + this.GetName();
		}

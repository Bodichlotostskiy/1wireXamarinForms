...
namespace _1wireXamarinForms.DalSemi.OneWire.Container
{
    ...
    public interface PagedMemoryBank : MemoryBank
    {
         ...
         *         adapter
         */
        void ReadPage(int page, Boolean readContinue, byte[] readBuf,
                              int offset);
         ...
         */
        int ReadPagePacket(int page, Boolean readContinue, byte[] readBuf,
                                   int offset);
         ...
         * @see #getMaxPacketDataLength() getMaxPacketDataLength 
         */
        void WritePagePacket(int page, byte[] writeBuf, int offset,
                                     int len);
         ...
         */
        void ReadPageCRC(int page, Boolean readContinue, byte[] readBuf,
                                 int offset);
